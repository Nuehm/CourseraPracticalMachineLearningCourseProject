...
###4.3 Out of Sample Error

The Out Of Sample Error is given by 100% - `r 100*acc1`% = `r 100 - 100*acc1`%. The model is thus properly performing on the test set.
  
  
###4.4 Predicting on the Test Set
